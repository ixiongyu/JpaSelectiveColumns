...
import com.xiongyu.generator.config.DriverConfig;
...
import com.xiongyu.generator.source.AbstractSourceParser;
import com.xiongyu.generator.source.EvaluateSourceCodeException;
import com.xiongyu.generator.tree.Element;
import com.xiongyu.state.AutoGeneratorSettingsState;
...
public enum TestTemplateHelper {
    ...
    public static Object evaluate(Class<? extends AbstractSourceParser> clazz, String template) {
        ...
        config.setDriverConfig(new DriverConfig()
            ...
            .setTablesConfig(
                new TablesConfig()
                    ...
                    .setIndent(Element.Indent.FOUR_SPACE.getIndent())
                    .setLineSeparator("\n")
                    .setOrm(TablesConfig.ORM.JPA)
        ...
        sourceParser.setVelocityEngine(com.xiongyu.util.VelocityUtil.getInstance(), "UTF-8");
        try {
            ...
            table
                ...
                .setSelected(true);
            table.getColumns().forEach(column -> com.xiongyu.util.ColumnUtil

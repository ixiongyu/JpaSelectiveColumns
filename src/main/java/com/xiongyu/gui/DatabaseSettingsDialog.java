...
import com.xiongyu.action.JpaSupport;

import com.xiongyu.component.DatabaseSettings;
import com.xiongyu.database.DatabaseDrivers;
import com.xiongyu.database.DriverDelegate;
...
import com.xiongyu.jdbc.SimpleDataSource;
import com.xiongyu.jdbc.SimpleFastJdbc;
  ...
  protected void doOKAction() {
    ...
    WriteCommandAction.runWriteCommandAction(project, () -> {
      ...
      try (Connection connection = DriverManager.getConnection(connectionUrl, username, password)) {
        FastJdbc fastJdbc = new SimpleFastJdbc(new SimpleDataSource(connectionUrl, username, password));

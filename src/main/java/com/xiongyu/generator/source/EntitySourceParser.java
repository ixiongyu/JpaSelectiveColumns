...
import com.xiongyu.generator.tree.visitor.BasicVisitor;
import com.xiongyu.generator.tree.visitor.JpaVisitor;
import com.xiongyu.generator.tree.visitor.MybatisVisitor;
...
public class EntitySourceParser implements SourceParser {
  ...
  public String parse(GeneratorConfig config, Table table) {
    ...
    sourceFile.addChild(new Package(table.getPackageName()));
    Import myImport = new Import();
    sourceFile.addChild(myImport);
    com.xiongyu.generator.tree.Class myClass = new com.xiongyu.generator.tree.Class(
        table.getEntityName());
